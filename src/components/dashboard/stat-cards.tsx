...
function StatCard({ stat, index }: { stat: Stat; index: number }) {
  ...
  return (
    <motion.div
      ...
      className="group rounded-[4px] border border-border bg-card p-5 transition-[transform,border-color,box-shadow,background-color] duration-200 ease-out hover:-translate-y-1 hover:border-foreground/25 hover:bg-secondary/45 hover:shadow-[0_1px_2px_rgba(0,0,0,0.08),0_14px_30px_-20px_rgba(0,0,0,0.34)] motion-reduce:hover:translate-y-0"
    >
