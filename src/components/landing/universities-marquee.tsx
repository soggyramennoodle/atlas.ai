...
export const UNIVERSITIES = [
  ...
  { src: "/universities/penn.png", name: "University of Pennsylvania" },
  ...
  { src: "/universities/brown.png", name: "Brown University" },
