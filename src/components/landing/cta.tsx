...
export function FinalCta({ ctaHref }: { ctaHref: string }) {
  return (
    <section className="overflow-hidden bg-[#000] px-6 pb-24 pt-10">
      <Reveal className="mx-auto max-w-[1200px] text-center">
        ...
        <h2 className="m-0 text-balance text-white">
          <span
        ...
        <p className="font-heading mx-auto mt-5 max-w-md text-pretty text-[16px] leading-[1.6] text-white/60">
        ...
        <div className="mt-9 flex justify-center">
          <Link
            href={ctaHref}
            className="font-heading flex items-center gap-2 rounded-full bg-white py-1.5 pl-6 pr-2 text-[15px] font-medium text-black transition-transform hover:scale-[1.02] active:scale-[0.98]"
          >
            Start for free
            <span className="grid size-6 place-items-center rounded-full bg-black">
              <ArrowUpRight size={14} color="#fff" strokeWidth={2.5} />
            </span>
          </Link>
        </div>
        <p className="font-heading mt-5 text-[12px] text-white/45">
