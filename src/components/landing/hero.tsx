...
export function Hero({
  ...
  return (
    ...
    <section className="relative flex min-h-[calc(100svh-5.75rem)] px-4 pb-24 pt-4 sm:px-6 sm:pb-28 sm:pt-6 lg:min-h-[calc(100svh-11rem)] lg:pb-4 lg:pt-2 lg:overflow-x-clip">
